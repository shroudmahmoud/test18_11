...
exports.projectLoadingNotification = {
    start: new vscodeLanguageclient__default['default'].NotificationType0('angular-language-service/projectLoadingStart'),
    finish: new vscodeLanguageclient__default['default'].NotificationType0('angular-language-service/projectLoadingFinish')
};
